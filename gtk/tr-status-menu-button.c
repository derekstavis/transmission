...
static void
tr_status_menu_button_set_property (GObject      *object,
                       guint         prop_id,
                       const GValue *value,
                       GParamSpec   *pspec)
{
...
static void
tr_status_menu_button_class_init (TrStatusMenuButtonClass *klass)
{
    ...
    gtk_widget_class_set_template_from_resource (widget_class,
      "/com/transmissionbt/transmission/tr-status-menu-button.ui"
    );
...
static void
tr_status_menu_button_init (TrStatusMenuButton *self)
{
    ...
    gtk_style_context_add_provider (context,
                                    GTK_STYLE_PROVIDER (TR_STATUS_MENU_BUTTON_GET_CLASS (self)->priv->css),
 ...
 */
GtkWidget *
tr_status_menu_button_new (void)
{
...
void
tr_status_menu_button_set_label (TrStatusMenuButton *button,
                    const gchar         *label)
{
...
const gchar *
tr_status_menu_button_get_label (TrStatusMenuButton *button)
{
