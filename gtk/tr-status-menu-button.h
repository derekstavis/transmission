...
#ifndef __TR_STATUS_MENU_BUTTON_H__
#define __TR_STATUS_MENU_BUTTON_H__
...
void tr_status_menu_button_set_label     (TrStatusMenuButton *button,
                         const gchar           *label);

const gchar *tr_status_menu_button_get_label (TrStatusMenuButton *button);

G_END_DECLS

#endif /* __TR_STATUS_MENU_BUTTON_H__ */
