 ...
 *
 * $Id: msgwin.c 13868 2013-01-25 23:34:20Z jordan $
 */
               ...
               gpointer    data)
{
  ...
  GtkWidget * d = gtk_file_chooser_dialog_new ("Open File", window,
...
gtr_message_log_window_new (GtkWindow * parent, TrCore * core)
{
  ...
  **/
  ...
  item = gtk_tool_button_new (
      gtk_image_new_from_icon_name("document-save-as-symbolic", GTK_ICON_SIZE_MENU),
      _("Save As")
  );
