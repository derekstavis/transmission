...
remotePage (GObject * core)
{
    ...
    /* access control list */
    {
        ...
        gtk_box_pack_start (GTK_BOX (w), gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0),
                            TRUE, TRUE, 0);
...
speedPage (GObject * core)
{
    ...
    gtk_box_pack_start (GTK_BOX (h), w, FALSE, FALSE, 0);
    w = gtk_image_new_from_icon_name ("alternative-speed-on-symbolic", GTK_ICON_SIZE_SMALL_TOOLBAR);
    gtk_box_pack_start (GTK_BOX (h), w, FALSE, FALSE, 0);
