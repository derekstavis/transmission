...
static GtkActionEntry entries[] =
{
    ...
    { "copy-magnet-link-to-clipboard",  NULL, N_("Copy _Magnet Link to Clipboard"), "", NULL,  G_CALLBACK (action_cb) },
    { "open-torrent-from-url",  NULL, N_("Open _URL…"), "<control>U", N_("Open URL…"),  G_CALLBACK (action_cb) },
    { "open-torrent-toolbar",  NULL, NULL, NULL, N_("Open a torrent"),  G_CALLBACK (action_cb) },
    { "open-torrent-menu", NULL, NULL, NULL, N_("Open a torrent"), G_CALLBACK (action_cb) },
    { "torrent-start", NULL, N_("_Start"), "<control>S", N_("Start torrent"), G_CALLBACK (action_cb) },
    { "torrent-start-now", NULL, N_("Start _Now"), "<shift><control>S", N_("Start torrent now"), G_CALLBACK (action_cb) },
    ...
    { "torrent-stop", NULL, N_("_Pause"), "<control>P", N_("Pause torrent"), G_CALLBACK (action_cb) },
    { "pause-all-torrents", NULL, N_("_Pause All"), NULL, N_("Pause all torrents"), G_CALLBACK (action_cb) },
    { "start-all-torrents", NULL, N_("_Start All"), NULL, N_("Start all torrents"), G_CALLBACK (action_cb) },
    { "relocate-torrent", NULL, N_("Set _Location…"), NULL, NULL, G_CALLBACK (action_cb) },
    { "remove-torrent", NULL, NULL, "Delete", N_("Remove torrent"), G_CALLBACK (action_cb) },
    { "delete-torrent", NULL, N_("_Delete Files and Remove"), "<shift>Delete", NULL, G_CALLBACK (action_cb) },
    { "new-torrent", NULL, N_("_New…"), NULL, N_("Create a torrent"), G_CALLBACK (action_cb) },
    { "quit", NULL, N_("_Quit"), NULL, NULL, G_CALLBACK (action_cb) },
    { "select-all", NULL, N_("Select _All"), "<control>A", NULL, G_CALLBACK (action_cb) },
    { "deselect-all", NULL, N_("Dese_lect All"), "<shift><control>A", NULL, G_CALLBACK (action_cb) },
    { "edit-preferences", NULL, NULL, NULL, NULL, G_CALLBACK (action_cb) },
    { "show-torrent-properties", NULL, NULL, "<alt>Return", N_("Torrent properties"), G_CALLBACK (action_cb) },
    { "open-torrent-folder",  NULL, N_("Open Fold_er"), "<control>E", NULL, G_CALLBACK (action_cb) },
    { "show-about-dialog", NULL, NULL, NULL, NULL, G_CALLBACK (action_cb) },
    { "help", NULL, N_("_Contents"), "F1", NULL, G_CALLBACK (action_cb) },
    { "torrent-reannounce", NULL, N_("Ask Tracker for _More Peers"), NULL, NULL, G_CALLBACK (action_cb) },
    { "queue-move-top", NULL, N_("Move to _Top"), NULL, NULL, G_CALLBACK (action_cb) },
    { "queue-move-up", NULL, N_("Move _Up"), NULL, NULL, G_CALLBACK (action_cb) },
    { "queue-move-down", NULL, N_("Move _Down"), NULL, NULL, G_CALLBACK (action_cb) },
    { "queue-move-bottom", NULL, N_("Move to _Bottom"), NULL, NULL, G_CALLBACK (action_cb) },
