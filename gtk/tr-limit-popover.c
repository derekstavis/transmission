...
static void
tr_limit_popover_class_init (TrLimitPopoverClass *klass)
{
	signals[SPEED_LIMIT_UP_CHANGED] =
		g_signal_new ("speed-limit-up",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		              G_STRUCT_OFFSET (TrLimitPopoverClass, speed_limit_up),
		              NULL, NULL,
		              g_cclosure_marshal_VOID__INT,
		              G_TYPE_NONE,
		              1, G_TYPE_INT);

	signals[SPEED_LIMIT_DOWN_CHANGED] =
		g_signal_new ("speed-limit-down",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		              G_STRUCT_OFFSET (TrLimitPopoverClass, speed_limit_down),
		              NULL, NULL,
		              g_cclosure_marshal_VOID__INT,
		              G_TYPE_NONE,
		              1, G_TYPE_INT);

	signals[RATIO_LIMIT_CHANGED] =
		g_signal_new ("ratio-limit",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		              G_STRUCT_OFFSET (TrLimitPopoverClass, ratio_limit),
		              NULL, NULL,
...
static void
on_entry_activate (GtkWidget *entry,
                   gpointer user_data)
{
	const char *text;
	int limit = 0;
...
static void
tr_limit_popover_init (TrLimitPopover *popover)
{
	TrLimitPopoverPrivate *priv;
	GtkWidget *w;
...
int
tr_limit_popover_get_speed_limit_up(TrLimitPopover *popover)
{
...
void
tr_limit_popover_set_speed_limit_up(TrLimitPopover *popover, int value)
{
	GtkSpinButton *entry = GTK_SPIN_BUTTON (popover->priv->upload_limit_entry);
...
void
tr_limit_popover_set_speed_limit_up_enabled(TrLimitPopover *popover, gboolean enabled)
{
...
int
tr_limit_popover_get_speed_limit_down(TrLimitPopover *popover)
{
...
void
tr_limit_popover_set_speed_limit_down(TrLimitPopover *popover, int value)
{
	GtkSpinButton *entry = GTK_SPIN_BUTTON (popover->priv->download_limit_entry);
	gtk_spin_button_set_value (entry, value);
}
...
void
tr_limit_popover_set_speed_limit_down_enabled(TrLimitPopover *popover, gboolean enabled)
{
...
double
tr_limit_popover_get_ratio_limit(TrLimitPopover *popover)
{
...
void
tr_limit_popover_set_ratio_limit(TrLimitPopover *popover, double value)
{
	GtkSpinButton *entry = GTK_SPIN_BUTTON (popover->priv->ratio_limit_entry);
	gtk_spin_button_set_value (entry, value);
}
...
void
tr_limit_popover_set_ratio_limit_enabled(TrLimitPopover *popover, gboolean enabled)
{
